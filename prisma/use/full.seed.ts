...
const filias = [
  {
    ...
    email: "camama.mukumba@gmail.com",
  ...
  },
  {
    ...
    tel: faker.helpers.fromRegExp(/9[1-5][0-9]{7}/),
    address: faker.location.streetAddress({ useFullAddress: true }),
    email: "vilaalice.mukumba@gmail.com",
...
export async function seedFull({
        ...
        agents: {
          create: Array.from({ length: 4 }).map((a) => {
            ...
            return {
              ...
              email: currentAgent.email.toLocaleLowerCase(),
  ...
  console.log(chalk.yellow("Drivers seeded"));
}
